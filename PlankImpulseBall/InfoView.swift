...
struct InfoView: View {
    var body: some View {
        ZStack {
            ...
            Text("Your goal is to guide the ball into the hole by creating waves. Tap near the ball to generate a wave that pushes it in the desired direction. Carefully aim your taps to control the ball's movement and avoid overshooting the hole. Each ball has its own designated hole, marked with a flag of the same color. Direct the ball of the matching color into its corresponding hole to win! Use precision and strategy to complete the challenge.")
